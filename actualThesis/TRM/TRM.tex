...
and the current is shown in Fig.~\ref{fig:analCurr}
 \begin{figure}[h!]
...
\end{figure}
 ...
 This also explains the oscillations observed at the boundaries; in alternating site, particles will tend to
 linger sites where they are alone, rapidly leaving when they are prompted by the arrival of a new particle in 
