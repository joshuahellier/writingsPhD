...
\end{center}
\end{figure}
In each of these results, we see that we have effectively partition the domain into two regimes:
...
are displayed in Fig.~\ref{fig:boundaryVarDens}, and the mean densities displayed in 
...
\frac{1}{2} \delta \rho)$, where we vary $\rho$, $\lambda$ and $\delta \rho$ simultaneously, where
...
\begin{itemize}
 ...
 \item We should have performed a larger number of shorter analysis runs; that was we would
...
\subsection{Aspect Ratio Considerations}
