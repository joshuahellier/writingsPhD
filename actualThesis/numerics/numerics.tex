...
\begin{center}
\includegraphics[width=1.0\textheight, angle=270]{numerics/images/lambdaScan/correctionsCombinedLogLarge}
\end{center}
\end{figure}
...
\begin{center}
\begin{tabular}{c} 
\includegraphics[width=1.0\linewidth]{numerics/images/diffCoeff/densityInstances} \\
\includegraphics[width=1.0\linewidth]{numerics/images/diffCoeff/graemeDensityProfile} \\
\end{tabular}
\end{center}
\end{figure}
...
\label{fig:2dSysDens}
\begin{center}
\includegraphics[width=0.95\textheight, angle=270]{numerics/images/2d/correctionsDensBoth}
\end{center}
\end{figure}
