...
\begin{center}
 \begin{tabular}{c@{\hspace{0.35em}}c}
    \includegraphics[height=0.3\paperheight]{../tex-src/images/supMatFlowImps/l05-crop} & \includegraphics[height=0.3\paperheight]{../tex-src/images/supMatFlowImps/l15-crop} \\
    \includegraphics[height=0.3\paperheight]{../tex-src/images/supMatFlowImps/l35-crop} & \includegraphics[height=0.3\paperheight]{../tex-src/images/supMatFlowImps/l25-crop} \\
    \end{tabular}
\end{center}
    \vspace{0em}
\end{figure*}
